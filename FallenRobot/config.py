class Config(object):
    ...
    EVENT_LOGS = -1002180614946  # Event logs channel to note down important bot level events
    ...
    TOKEN = "6779808820:AAFecOBrnU8gKEbhDLj-HdGiiIddbg9rWCw"  # Get bot token from @BotFather on Telegram

    TIME_API_KEY = ""  # Get this value from https://timezonedb.com/api

    OWNER_ID = 6367390521  # User id of your telegram account (Must be integer)
